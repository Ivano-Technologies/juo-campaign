...
export const donateStayClose =
  "Thank you. Naira bank transfer is published on this page. When online checkout opens, this page will carry receipt expectations and compliant card channels only.";

export const donateTransparencyTitle = "Transparency note";
export const donateTransparencyBody =
  "Transparent Government starts with how a campaign asks for support: openly, lawfully, and without pressure. The bank details on this page are the official naira transfer path. Further process detail will match counsel guidance when online checkout connects.";
