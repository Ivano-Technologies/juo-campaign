...
| `/news/[slug]` | News / community post detail |
| `/contact` | Contact |
| `/privacy` | Privacy Notice |
| `/terms` | Terms of Use |
| `/posters` | Campaign Poster Gallery |
