...
export const archibongPageDescription =
  "John Upan Odey Jnr and Apostle Dr. Stella Charles Archibong bring together decades of professional experience, public leadership and community service, united by a shared commitment to the people of Cross River.";
...
export const archibongBody = [
  ...
  "John Upan Odey Jnr brings a wealth of experience in finance, business strategy and institutional management, with a vision focused on economic opportunity, accountable governance, healthcare, education and infrastructure.",
